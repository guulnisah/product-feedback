import { UpvoteButton, PillButton, Suggestion } from '../components/Styles'
import { Link } from 'react-router-dom'
import { doc, updateDoc, increment } from 'firebase/firestore'
import { db } from '../firebase/config'


export default function displayFeedback(arr) {
    const result = arr.map((elem) => {
        return (
            <Suggestion key={elem.id}>
                <UpvoteButton column onClick={(e) => handleUpvote(e, elem.id)}>
