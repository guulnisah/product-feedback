...
import { Avatar, Button, Status, PillButton, HomeContainer, Header, Main, Nav } from '../../components/Styles'
...
export default function Home() {
    ...
    const filteredSuggestions = suggestions ? suggestions
        .sort((a, b) => {
        ...
        <HomeContainer>
            <Header>
                <div className="head">
                    ...
                    <div className="greeting">
                        <Avatar width="60px" src={user.photoURL} />
                        <div>
            ...
            <Main>
                <Nav>
                    ...
                    <Dropdown styles={navDropdownStyles} text="Sort by: " items={sortItems} state={sortBy} setState={setSortBy} onChange={handleChange} />
